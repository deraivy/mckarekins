      ...
      >
        <div class="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <NuxtLink to="/" class="flex items-center gap-3">
            <div
              class="w-10 h-10 rounded-xl bg-gradient-to-br from-leaf to-moss flex items-center justify-center text-xl shadow-lg"
            >
              🌾
            </div>
            <div>
          ...
          <!-- Desktop Links -->
          <div
            class="hidden md:flex items-center gap-8 text-cream/80 text-sm font-medium"
          >
      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div class="space-y-4">
            ...
            <ul class="space-y-2">
              <li>
                <NuxtLink to="/" class="text-white hover:text-white transition"
                  >Home</NuxtLink
                >
              </li>
              <li>
          ...
          <div class="space-y-4">
            ...
            <address class="not-italic text-white">
              ...
              <p class="mt-2">
                Phone:
                <a href="tel:+2347042641446" class="hover:text-white transition"
                  >+234 704 2641-446</a
                >
              </p>
            </address>
